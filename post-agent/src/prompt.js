...
const PLATFORM_RULES = {
  linkedin: `Write a thoughtful LinkedIn post. Start with a strong observation or hook, explain the problem, connect it to the project, and end with a conversational question or restrained CTA. Use short paragraphs. Avoid corporate jargon and excessive hashtags. Target 180-300 words.`,
  x: `Write an X post or short thread. Make the first line stand alone as a hook. Use concise, conversational language. If a thread helps, number it clearly with 1/, 2/, etc. Target 1-5 short posts and stay within normal X post length. Do not add filler hashtags.`,
...
Return only one concise topic phrase, between 4 and 12 words. Do not write the post, explain your choice, use a hashtag, or invent a feature or result.`;
}
...
- Do not imply that web research measured Snehayog's impact.
...
Fix every problem you find. If the draft already passes all seven checks, return it unchanged.
